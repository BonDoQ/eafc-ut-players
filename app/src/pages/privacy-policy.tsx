  ...
  return (
    <ContentGrid>
      <>
        ...
        <p>
          We aim to keep your use of our website anonymous whenever possible. If we do collect personal information
          (like name, address, or email), it's on a voluntary basis and won't be shared without your consent. We don't
          allow third parties to use contact information provided on our site for unsolicited advertising or spam. Legal
          action will be taken against any such misuse.
        </p>
        ...
        <p>
          ...
          <a href="mailto:info@eafcdb.app">info@eafcdb.app</a>
        </p>
      </>
    </ContentGrid>
  );
